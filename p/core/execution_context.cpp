...
module p.core.execution_context;
...
Frame::Frame(int32_t size_, const std::vector<ParameterSymbol*>& parameters, SubroutineSymbol* subroutine_) :
...
ExecutionContext::ExecutionContext() : Context(), stack(), heap(nullptr), globalVariableMap(nullptr), currentSubroutine(nullptr)
{
}
...
void ExecutionContext::PushSubroutine(SubroutineSymbol* subroutine)
{
