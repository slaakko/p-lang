...
{
    static soul::ast::slg::TokenCollection tokens("p.line.lexer.tokens");
    if (!tokens.Initialized())
    {
        ...
        tokens.AddToken(new soul::ast::slg::Token(KEYWORD_TOKEN, "KEYWORD_TOKEN", "keyword"));
        tokens.AddToken(new soul::ast::slg::Token(IDENTIFIER_TOKEN, "IDENTIFIER_TOKEN", "identifier"));
        tokens.AddToken(new soul::ast::slg::Token(NUMBER_TOKEN, "NUMBER_TOKEN", "number"));
        tokens.AddToken(new soul::ast::slg::Token(STRING_TOKEN, "STRING_TOKEN", "string"));
        tokens.AddToken(new soul::ast::slg::Token(START_BRACE_COMMENT_TOKEN, "START_BRACE_COMMENT_TOKEN", "start brace comment"));
        tokens.AddToken(new soul::ast::slg::Token(END_BRACE_COMMENT_TOKEN, "END_BRACE_COMMENT_TOKEN", "end brace comment"));
        tokens.AddToken(new soul::ast::slg::Token(START_BLOCK_COMMENT_TOKEN, "START_BLOCK_COMMENT_TOKEN", "start block comment"));
        tokens.AddToken(new soul::ast::slg::Token(END_BLOCK_COMMENT_TOKEN, "END_BLOCK_COMMENT_TOKEN", "end block comment"));
        tokens.AddToken(new soul::ast::slg::Token(OTHER_TOKEN, "OTHER_TOKEN", "other"));
        tokens.AddToken(new soul::ast::slg::Token(WS_TOKEN, "WS_TOKEN", "ws"));
    }
    return &tokens;
}

PLineLexer_Variables::PLineLexer_Variables()
{
}
