...
procedure MakeDiagrams();
  ...
  begin
    ...
    expressionStatement := new RuleBox('expression-statement');
    diagram.AddShape(1, 1, expressionStatement);
    branch2 := new Branch();
    diagram.AddShape(0, 2, branch2);
    out := new Out();
    diagram.AddShape(0, 3, out);
    diagram.AddConnector(new SyntaxArrow(title, assignmentStatement, east, noDir));
    diagram.AddConnector(new SyntaxArrow(branch1, expressionStatement, south, east));
    diagram.AddConnector(new SyntaxArrow(expressionStatement, branch2, east, north));
  ...
  procedure MakeExpressionStatementDiagram();
  var
    title: DiagramTitle;
    diagram: Diagram;
    gap1, gap2: Gap;
    ...
    out: Out;
  begin
    title := new DiagramTitle('expression-statement');
    diagram := new Diagram(title, 'expression-statement.png');
    gap1 := new Gap();
    diagram.AddShape(0, 0, gap1);
  ...
  begin
    ...
    diagram.AddShape(0, 0, branch1);
    semicolon := new Terminal(';');
    diagram.AddShape(1, 1, semicolon);
    branch2 := new Branch();
    diagram.AddShape(0, 2, branch2);
    elseKeyword := new Keyword('else');
    diagram.AddShape(0, 3, elseKeyword);
    gap1 := new Gap();
    diagram.AddShape(0, 4, gap1);
    statement := new RuleBox('statement');
    diagram.AddShape(0, 5, statement);
    ...
    diagram.AddConnector(new SyntaxArrow(branch1, semicolon, south, east));
    diagram.AddConnector(new SyntaxArrow(semicolon, branch2, east, north));
  ...
  begin
    ...
    diagram.AddShape(5, 1, newExpression);
    thisKeyword := new Keyword('this');
    diagram.AddShape(6, 1, thisKeyword);
    baseKeyword := new Keyword('base');
    diagram.AddShape(7, 1, baseKeyword);
    typeName := new RuleBox('type-name');
    diagram.AddShape(8, 1, typeName);
    diagram.AddConnector(new SyntaxArrow(title, identifier, east, noDir));
    diagram.AddConnector(new SyntaxArrow(identifier, out, east, noDir));
    ...
    diagram.AddConnector(new SyntaxArrow(branch1, typeName, south, east));
    ...
    diagram.AddConnector(new SyntaxArrow(typeName, branch2, east, north));
    AddDiagram(diagram);
  end;
  ...
  begin
    ...
    diagram.AddShape(1, 1, arrayType);
    integerKeyword := new Keyword('integer');
    diagram.AddShape(2, 1, integerKeyword);
    realKeyword := new Keyword('real');
    diagram.AddShape(3, 1, realKeyword);
    charKeyword := new Keyword('char');
    diagram.AddShape(4, 1, charKeyword);
    booleanKeyword := new Keyword('boolean');
    diagram.AddShape(5, 1, booleanKeyword);
    stringKeyword := new Keyword('string');
    diagram.AddShape(6, 1, stringKeyword);
    pointerKeyword := new Keyword('pointer');
    diagram.AddShape(7, 1, pointerKeyword);
    branch2 := new Branch();
    diagram.AddShape(0, 2, branch2);
    out := new Out();
    diagram.AddShape(0, 3, out);
  ...
  begin
    ...
    diagram.AddShape(2, 1, trueKeyword);
    falseKeyword := new Keyword('false');
    diagram.AddShape(3, 1, falseKeyword);
    nilKeyword := new Keyword('nil');
    diagram.AddShape(4, 1, nilKeyword);
    branch2 := new Branch();
    diagram.AddShape(0, 2, branch2);
    out := new Out();
    diagram.AddShape(0, 3, out);
  ...
  begin
    ...
    memberSelection := new RuleBox('member-selection');
    diagram.AddShape(1, 1, memberSelection);
    branch2 := new Branch();
    diagram.AddShape(0, 2, branch2);
    out := new Out();
    diagram.AddShape(0, 3, out);
    ...
    diagram.AddConnector(new SyntaxArrow(branch1, memberSelection, south, east));
    diagram.AddConnector(new SyntaxArrow(memberSelection, branch2, east, north));
    AddDiagram(diagram);
  end;
  ...
  procedure MakeMemberSelectionDiagram();
  var
    title: DiagramTitle;
    diagram: Diagram;
    dot: Terminal;
    ...
    out: Out;
  begin
    title := new DiagramTitle('member-selection');
    diagram := new Diagram(title, 'member-selection.png');
    gap1 := new Gap();
    diagram.AddShape(0, 0, gap1);
    dot := new Terminal('.');
  ...
  begin
    ...
    gap3 := new Gap();
    diagram.AddShape(0, 4, gap3);
    typeRule := new RuleBox('type-name');
  ...
  var
    ...
    gap1, gap2, gap3, gap4: Gap;
    out: Out;
    lparen, rparen, colon, semicolon: Terminal;
  ...
  begin
    ...
    diagram.AddConnector(new SyntaxArrow(fieldName, colon, east, noDir));
    diagram.AddConnector(new SyntaxArrow(colon, constant, east, noDir));
    diagram.AddConnector(new SyntaxArrow(constant, rparen, east, noDir));
    diagram.AddConnector(new SyntaxArrow(rparen, out, east, noDir));
    diagram.AddConnector(new SyntaxLine(branch2, semicolon, south, west));
    diagram.AddConnector(new SyntaxArrow(semicolon, branch1, west, north));
    AddDiagram(diagram);
  end;
  ...
  var
    ...
    diagram: Diagram;
    branch1, branch2: Branch;
    simpleType, stringType, pointerType, objectType, arrayType, specialization, typeIdentifier: RuleBox;
    out: Out;
  begin
    ...
    specialization := new RuleBox('specialization');
    diagram.AddShape(5, 1, specialization);
    typeIdentifier := new RuleBox('type-identifier');
    diagram.AddShape(6, 1, typeIdentifier);
    branch2 := new Branch();
    diagram.AddShape(0, 2, branch2);
    out := new Out();
    diagram.AddShape(0, 3, out);
    ...
    diagram.AddConnector(new SyntaxArrow(branch1, arrayType, south, east));
    diagram.AddConnector(new SyntaxArrow(branch1, specialization, south, east));
    ...
    diagram.AddConnector(new SyntaxArrow(arrayType, branch2, east, north));
    diagram.AddConnector(new SyntaxArrow(specialization, branch2, east, north));
  ...
  var
    ...
    branch1, branch2, branch3, branch4: Branch;
    heritage, genericPart, componentList: RuleBox;
    endKeyword: Keyword;
    out: Out;
  begin
    ...
    genericPart := new RuleBox('generic-part');
    diagram.AddShape(1, 6, genericPart);
    branch4 := new Branch();
    diagram.AddShape(0, 7, branch4);
    componentList := new RuleBox('component-list');
    diagram.AddShape(0, 8, componentList);
    gap2 := new Gap();
    diagram.AddShape(0, 9, gap2);
    endKeyword := new Keyword('end');
    diagram.AddShape(0, 10, endKeyword);
    gap3 := new Gap();
    diagram.AddShape(0, 11, gap3);
    out := new Out();
    diagram.AddShape(0, 12, out);
    ...
    diagram.AddConnector(new SyntaxArrow(branch3, genericPart, south, east));
    diagram.AddConnector(new SyntaxArrow(heritage, branch2, east, north));
    diagram.AddConnector(new SyntaxArrow(genericPart, branch4, east, north));
    AddDiagram(diagram);
  end;
  ...
  procedure MakeGenericPartDiagram();
  var
    title: DiagramTitle;
    diagram: Diagram;
    gap1, gap2, gap3: Gap;
    ...
    out: Out;
  begin
    title := new DiagramTitle('generic-part');
    diagram := new Diagram(title, 'generic-part.png');
    gap1 := new Gap();
    diagram.AddShape(0, 0, gap1);
    ofKeyword := new Keyword('of');
    diagram.AddShape(0, 1, ofKeyword);
    gap2 := new Gap();
    diagram.AddShape(0, 2, gap2);
    identifier := new RuleBox('identifier');
    diagram.AddShape(0, 3, identifier);
    ...
    out := new Out();
    diagram.AddShape(0, 5, out);
    diagram.AddConnector(new SyntaxArrow(title, ofKeyword, east, noDir));
    diagram.AddConnector(new SyntaxArrow(ofKeyword, identifier, east, noDir));
    diagram.AddConnector(new SyntaxArrow(identifier, out, east, noDir));
    AddDiagram(diagram);
  end;
  ...
  var
    ...
    out: Out;
  begin
    title := new DiagramTitle('virtual');
    diagram := new Diagram(title, 'virtual.png');
    branch1 := new Branch();
    diagram.AddShape(0, 0, branch1);
  ...
  procedure MakeSpecializationDiagram();
  var
    title: DiagramTitle;
    diagram: Diagram;
    identifier: RuleBox;
    ...
    out: Out;
  begin
    title := new DiagramTitle('specialization');
    diagram := new Diagram(title, 'specialization.png');
    gap1 := new Gap();
    diagram.AddShape(0, 0, gap1);
    identifier := new RuleBox('identifier');
    diagram.AddShape(0, 1, identifier);
    ...
    diagram.AddShape(0, 7, out);
    diagram.AddConnector(new SyntaxArrow(title, identifier, east, noDir));
    diagram.AddConnector(new SyntaxArrow(identifier, ofKeyword, east, noDir));
    diagram.AddConnector(new SyntaxArrow(ofKeyword, typeRule, east, noDir));
    diagram.AddConnector(new SyntaxArrow(typeRule, out, east, noDir));
    AddDiagram(diagram);
  end;
...
begin
  ...
  MakeExpressionStatementDiagram();
